...
const DeleteConfirmModal = ({ open, onClose, onConfirm, loading = false }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-xl p-6 w-[340px] shadow-lg"
      ...
      >
        ...
        <div className="flex justify-end gap-3">
          <button
            disabled={loading}
            onClick={onClose}
            className="px-5 py-2 border rounded-lg disabled:opacity-60"
          >
            Cancel
          </button>
          ...
          <button
            disabled={loading}
            onClick={onConfirm}
            className="px-5 py-2 bg-red-100 text-red-600 rounded-lg disabled:opacity-60"
          >
