...
//         <p className="text-gray-600 mb-6">No saved addresses yet</p>
//         <button
//           onClick={() => navigate("/account/addresses?address-id=new")}
//           className="bg-primary px-8 py-3 rounded-lg text-white font-semibold hover:bg-secondary"
//         >
//           ADD NEW ADDRESS
//         </button>
//       </div>
...
//               <button
//                 disabled={deleting && toDelete === addr.id}
//                 onClick={() => setToDelete(addr.id)}
//                 className="flex-1 border border-gray-300 rounded-lg py-2 font-semibold hover:bg-gray-100 disabled:opacity-60"
//               >
//                 {deleting && toDelete === addr.id ? "Removing..." : "Remove"}
//               </button>
//             </div>
//           </div>
//         ))}
