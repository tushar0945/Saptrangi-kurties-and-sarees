...
const ProfileCard = () => {
  ...
  // Masked mobile (last 4 digits)
  // const maskedMobile = mobile ? `****${mobile.slice(-4)}` : "No mobile";
    ...
    >
      ...
      <div className="flex items-center gap-4 md:gap-6">
        ...
        <div>
          ...
          <p className="text-dark/70 text-sm sm:text-base">{email}</p>

          <p className="text-dark/70 text-sm sm:text-base">{mobile}</p>
        </div>
      </div>
