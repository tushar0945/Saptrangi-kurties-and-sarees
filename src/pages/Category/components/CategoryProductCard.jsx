...
//       <div className="w-full rounded-xl transition-all group">
//         <div className="relative w-full h-[300px] sm:h-[320px] md:h-[330px] lg:h-[360px] rounded-xl overflow-hidden">
//           <img
//             src={main_image}
//             alt={title}
//             className="absolute inset-0 w-full h-full object-cover transition-opacity duration-500 opacity-100 group-hover:opacity-0 object-[center_-0%]"
//           />
//           <img
...
//           <h3 className="text-xs font-bold text-gray-600">Saajnika</h3>
