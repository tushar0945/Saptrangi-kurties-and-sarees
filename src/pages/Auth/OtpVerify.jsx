    ...
    >
      ...
      >
        ...
        <form onSubmit={handleVerify} className="mt-6 space-y-6">
          ...
          <div className="flex justify-center gap-3">
            {otp.map((digit, index) => (
              <input
                ...
                value={digit}
                ref={(el) => (inputRefs.current[index] = el)}
                className="w-12 h-12 text-center border border-primary/40 bg-primary/5 
                rounded-xl text-lg font-semibold text-gray-700 
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-primary to-secondary text-white font-semibold py-3 rounded-2xl shadow-md 
