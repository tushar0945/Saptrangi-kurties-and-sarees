...
//           <button
//             type="submit"
//             className="w-full bg-gradient-to-r from-primary to-secondary text-white font-semibold py-3 rounded-2xl shadow-md hover:opacity-90 active:scale-95 transition-all duration-200"
//           >
//             Send OTP
//           </button>
//         </form>
